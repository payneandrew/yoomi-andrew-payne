...
const ExerciseButton: React.FC<ExerciseButtonProps> = ({ exercise }) => {
  return (
    <div className="flex rounded-r-lg border-l-2 border-white bg-coral-blue p-1 gap-2 items-center">
